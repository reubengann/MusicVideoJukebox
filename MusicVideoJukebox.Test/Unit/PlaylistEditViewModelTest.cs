...
namespace MusicVideoJukebox.Test.Unit
{
    public class PlaylistEditViewModelTest
    {
        ...
        public async Task LoadsPlaylists()
        {
            ...
            metadataManagerFactory.ToReturn.ConcreteVideoRepo.Playlists.Add(new Playlist { PlaylistId = 1, PlaylistName = "playlist 1" });
        ...
        {
            await libraryStore.SetLibrary(1, "foobar");
            metadataManagerFactory.ToReturn.ConcreteVideoRepo.Playlists.Add(new Playlist { PlaylistId = 1, PlaylistName = "New Playlist" });
            await dut.Initialize();
        ...
        public async Task SavesExistingPlaylist()
        {
            ...
            Assert.Equal("changed", metadataManagerFactory.ToReturn.ConcreteVideoRepo.Playlists[0].PlaylistName);
        ...
        {
            await libraryStore.SetLibrary(1, "foobar");
            metadataManagerFactory.ToReturn.ConcreteVideoRepo.Playlists.Add(new Playlist { PlaylistId = 1, PlaylistName = "All Songs" });
            await dut.Initialize();
        ...
        {
            await libraryStore.SetLibrary(1, "foobar");
            metadataManagerFactory.ToReturn.ConcreteVideoRepo.Playlists.Add(new Playlist { PlaylistId = 1, PlaylistName = "All Songs", IsAll = true });
            await dut.Initialize();
        ...
        public async Task CanAddTracksToPlaylist()
        {
            ...
            Assert.Equal(2, metadataManagerFactory.ToReturn.ConcreteVideoRepo.AppendedToPlaylist.Count);
        }
    }
}
